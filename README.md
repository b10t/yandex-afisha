...
### Загрузка данных из формата [GeoJSON](https://ru.wikipedia.org/wiki/GeoJSON)  

Для загрузки данных из файла формата GeoJSON, выполните следующую команду:
```bash
...
где:
```console
geojson_url: ссылка на файл формата GeoJSON (пример формата файла ниже).  
```

Пример формата файла [GeoJSON](https://ru.wikipedia.org/wiki/GeoJSON):  
```json
{
...
Описание формата GeoJSON: [wiki](https://ru.wikipedia.org/wiki/GeoJSON)
